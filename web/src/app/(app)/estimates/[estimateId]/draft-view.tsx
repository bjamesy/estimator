...
// to type into. Clicking a line selects it; the builder panel on the
// periphery is where editing actually happens (see estimate-builder.tsx).
          ...
          return (
            <li key={line.id}>
              <button
                ...
                className={cn(
                  "flex w-full flex-wrap items-center justify-between gap-x-4 gap-y-1 px-4 py-3 text-left transition-colors",
